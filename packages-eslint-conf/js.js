module.exports = {
  ...
  "rules": {
    ...
    "lines-between-class-members": ["error", "always", { "exceptAfterSingleLine": false }], // 类成员之间使用空行
    /**
     * 遍历
     */
    ...
    "lines-around-comment": [1, { 'beforeBlockComment': true, 'beforeLineComment': true }], // 要求在注释周围有空行
