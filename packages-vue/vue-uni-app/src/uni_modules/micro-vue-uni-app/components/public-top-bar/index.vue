...
import {
  ...
  computed, defineProps, getCurrentInstance
} from "vue";
...
const style = computed(() => {
  let style = `height:${CustomBar}px; padding-top:${StatusBar}px;  background-color:${props.bgColor}; background-size: 100% 100%;`;
...
<template>
  ...
  >
    ...
    >
      ...
      <view
        class="content"
        :style="[{ top: StatusBar + 'px', color: color }]"
      >
        <slot></slot>
      </view>
